<template>
  <div class="banner-wrapper">
              <section class="banner-two banner-carousel__one no-dots owl-theme owl-carousel">
                  <div class="banner-two__slide banner-two__slide-one" :style="{backgroundImage: `url(/assets/images/banner2.jpg)`}">
                      <div class="container">
                  ...
                  <div class="banner-two__slide banner-two__slide-two" :style="{backgroundImage: `url(/assets/images/banner.jpg)`}">
                      <div class="container">
                          <div class="row no-gutters">
                              <div class="col-xl-12">
                                  <p class="banner-two__tag-line">High quality courses</p><!-- /.banner-two__tag-line -->
