          ...
          <div class="row">
              <div class="col-lg-6">
                  <div class="meeting-one__image">
                      <img src="/assets/images/img_srtg.jpg" alt="Awesome Image" style="width:570px;height:690" />
                  </div><!-- /.meeting-one__image -->
              </div><!-- /.col-lg-6 -->
              <div class="col-lg-6">
                  <div class="meeting-one__content">
                      <div class="block-title text-left">
                          <h3 class="block-title__title">Nouveaux  <br>
                            Articles  & nouveautés</h3><!-- /.block-title__title -->
                      </div><!-- /.block-title -->
